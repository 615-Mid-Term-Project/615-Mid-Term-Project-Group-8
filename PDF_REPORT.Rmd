...
5 scatter plots show the splits among the measurement groups and 4 scatter plots that stratify state against bee toxin level
...
We can see that the percentage of the pesticide's usage which included high bee toxins is decreasing. We will 
