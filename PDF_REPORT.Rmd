...
# Group 8 Strawberry Report
## After wrangling data, we only have dataset from 4 states, 
## which are California, Florida, Oregon and Washington. 
## And we filtered the whole dataset by measured in pounds.
## By counting the observation grouped by State, we have a map plot,
## which showed in the california, there are more observations.
```{r}
## map plot
